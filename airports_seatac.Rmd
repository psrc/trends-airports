...
create.monthly.area.chart.by.year <- function(category) {
  ...
  # labels
  if (category == "passenger") category <- "passengers" 
  # unit
...
suppressMessages(export.seatac.excel())

```

The arguments for visual functions are: "passenger", "all cargo", "all freight cargo", "domestic freight cargo", "international freight cargo", "mail cargo"
```{r Area Chart by Month and Year (ggplotly)} 

create.monthly.area.chart.by.year("passenger")

```

```{r Barchart by Month and Current/Previous Years}

create.barchart.by.month("mail cargo")
